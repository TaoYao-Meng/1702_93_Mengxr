...
<table border="1" bgcolor="#ffffff" align="center" cellpadding="1">
    ...
    <s:iterator value="#session.friend_list" var="tr">
        <tr>
            ...
            <td width="15%"><a  href="own_action.action?shan=<s:property value="#tr.id"/>"><s:property value="#tr.name"/></a></td>
            ...
            <td width="15%" ><a href="friend_show_action!delete.action?shan=<s:property value="#tr.id"/>&shan2=<s:property value="#tr.name"/>"> 删除 </a></td>
        </tr>
    </s:iterator>
</table>
