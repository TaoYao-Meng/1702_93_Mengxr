...
<div class="htmleaf-container">
    <header class="htmleaf-header">
        ...
        <%--</div>--%>
        <form action="car_action!find.action" method="post" >
            <input type="text" name="back"><button type="submit" id="dimbutton" >查询</button>
        </form>
    </header>
    <main class="sortable">
        <div class="container">
                ...
                <div id="sortable" class="sjs-default">
                    ...
                    <div data-sjsel="flatty">
                        <div class="card">
                            ...
                            <img class="card__picture" src="car_pic/<s:property value="#tr.pic"/>" alt="">
                                </a>
                            </div>
