...
<body>
<a href=manager_action!read_car.action> 查看全部商品 </a>
<a href=login.jsp>注销</a>
<form action="manager_action!find_user.action" method="post">查找:<input type="text" name="back" /><input type="submit"/> </form>
<table border="1" bgcolor="#ffffff" align="center" cellpadding="1">
    ...
    <s:iterator value="#session.manager_user_list" var="tr">
        <tr>
            ...
            <td valign="middle" align="center" width="20%"><a href="manager_action!delete_user.action?shan=<s:property value="#tr.id"/>"> 删除 </a></td>
        </tr>
    </s:iterator>
</table>
