...
<%--                    <tr>--%>
<%--                        <TD><img src="../sculpture/<s:property value="#tr.id"/>.jpg" width="80" height="80"/></TD>--%>
<%--                        <td><s:property value="#tr.id"/></td>--%>

<%--                        <td><s:property value="#tr.name"/></td>--%>
<%--                        <td><s:property value="#tr.address"/></td>--%>
<%--                        <td><a href="manager_action!delete_user?shan=<s:property value="#tr.id"/>"> 删除 </a></td>--%>
<%--                    </tr>--%>
<%--                </s:iterator>--%>
    ...
    <section id="scene" data-pointer-events="true" data-x-origin="0.5" data-y-origin="0.5" data-scalar-y="150.0" data-scalar-x="100.0" data-friction-x="0.05" data-friction-y="0.05">
        <div class="layer main" data-depth="1.0">
            ...
            <s:iterator value="#session.manager_user_list" var="tr">
            <div class="col">
                <a href="detileManger.jsp">
                    <div class="hover">
                        <div class="pad align-bottom">
                            <h2><s:property value="#tr.name"/></h2>
                        </div>
                    </div>
                    <div class="bg-img"><img src="../sculpture/<s:property value="#tr.id"/>.jpg" width="100%" height="100%"></div>
                </a>
            </div>
            </s:iterator>
