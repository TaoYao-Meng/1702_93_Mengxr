...
<br>
<form action="manager_action!find_car.action" method="post">查找:<input type="text" name="back" /><input type="submit"/> </form>
    ...
    <s:iterator value="#session.manager_car_list" var="tr">
        <tr>
            ...
            <td width="10%" valign="middle" align="center">
                <a href="manager_action!delete_car.action?shan=<s:property value="#tr.id"/> " > 删除 </a>
            </td>
        </tr>
    </s:iterator>
</table>
