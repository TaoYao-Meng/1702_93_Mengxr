...
<table border="1" bgcolor="#ffffff" align="center" cellpadding="1">
    ...
    <s:iterator value="#session.apply_list" var="tr">
        <tr>
            ...
            <td><a href="apply_action!add_friend.action?shan=<s:property value="#tr.id"/>&shan2=<s:property value="#tr.send_id"/>&back=1">同意</a></td>
            <td><a href="apply_action!refuse_friend.action?shan=<s:property value="#tr.id"/>&shan2=<s:property value="#tr.send_id"/>&back=0">拒绝</a></td>
        </tr>
    </s:iterator>
</table>
