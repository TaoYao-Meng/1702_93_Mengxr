...
<div>
    <div style="float: left">
        ...
        <br>
        <input type="button" onclick="window.location='web/change_describe.jsp?id=<s:property value="#session.info.id"/>&de=<s:property value="#session.info.describe"/>'" value="修改相关信息"/>
        <input type="button" onclick="window.location='web/add_car_photo.jsp?id=<s:property value="#session.info.id"/>'" value="添加"/>
    ...
    <div  style="float: left;">
        <table class="gridtable" border="1" bgcolor="#ffffff"  cellspacing="1" cellpadding="1" width="400px" style=" position: relative;left: 10px;top: 20px;">
            ...
            <tr>
                <td>    </td>
                <td><a href="detail_action!dele.action?shan=<s:property value="#tr.id"/>&shan2=<s:property value="#session.info.id"/>">删除</a></td>
            </tr>
            </s:iterator>
            </tr>
