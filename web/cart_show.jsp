    ...
    <table border="1" bgcolor="#ffffff" align="center" cellspacing="1" cellpadding="1">
        ...
        <s:iterator value="#session.cart_list" var="tr">
            <tr>
                ...
                <td width="10%">
                    <a href=cart_action!chan.action?shan=<s:property value="#tr.id"/>&shan2=0" >减少</a>
                </td>
                <td width="10%"><a href="cart_action!chan.action?shan=<s:property value="#tr.id"/>&shan2=1"> 增加 </a></td>
            </tr>
        </s:iterator>
    </table>
</div>
<div align="center">
    ...
    <button><a href=cart_action!buy.action?shan=<s:property value="#tr.id"/>&shan2=0" t>购买</a></button>
</div>
</body>
</html>