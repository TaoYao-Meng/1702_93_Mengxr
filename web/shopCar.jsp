...
<table border="0" bgcolor="#ffffff" align="center" cellpadding="1">
    ...
    <s:iterator value="#session.cart_list" var="tr">
        <tr>
            ...
            <td width=10% align="center"><a href="cart_action!chan.action?shan=<s:property value="#tr.id"/>&shan2=1"> 增加 </a></td>
        </tr>
    </s:iterator>
</table>
<mid>
    <td>总价:<s:property value="#session.all"/></td>
    <a href=cart_action!buy.action?shan=<s:property value="#tr.id"/>&shan2=0" >购买</a>
</mid>
</body>
</html>
